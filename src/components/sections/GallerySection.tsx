...
const GALLERY_TOP = [
  ...
  },
  {
    ...
    caption: "All the love in one room",
...
export function GallerySection() {
  return (
    <section id="gallery" className="relative w-full overflow-hidden py-20 sm:py-24">
